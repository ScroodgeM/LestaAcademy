Shader "ExampleScreen"
{
    Properties
    {
        ...
        _ScannerDistanceMin ("Scanner Distance Min", Range(0,300)) = 100
        _ScannerDistanceMax ("Scanner Distance Max", Range(0,300)) = 100
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float dist = lerp(_ScannerDistanceMin, _ScannerDistanceMax, sin(_Time.w * 0.5) * 0.5 + 0.5);
                col += saturate(1.0 - 0.2 * abs(depth - dist)) * _ScannerColor;
